...
public:
	float speed{ 0.0f };
	spaceship(rendering::rendering3d::model model) : _model(model), max_speed(1.0f) {}
	spaceship(rendering::rendering3d::model model, float max_speed) : _model(model), max_speed(max_speed) {}
